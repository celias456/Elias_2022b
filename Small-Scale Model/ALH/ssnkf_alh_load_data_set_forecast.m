function [mh_theta,mh_theta_A,mh_theta_B,mh_theta_R_A,mh_theta_R_B,mh_theta_s,mh_theta_P,data_forecast_sample,T,H,TpH,Sigma_u_sd] = ssnkf_alh_load_data_set_forecast(data_set_identifier)
...
if data_set_identifier == 1 %2001
    ...
    %Load the MH draws
    load('ssnkf_alh_mh_draws_2001.mat','mh_theta','mh_theta_A','mh_theta_B','mh_theta_R_A','mh_theta_R_B','mh_theta_s','mh_theta_P','T');
           
elseif data_set_identifier == 2 %2007
    
    %Load the MH draws
    load('ssnkf_alh_mh_draws_2007.mat','mh_theta','mh_theta_A','mh_theta_B','mh_theta_R_A','mh_theta_R_B','mh_theta_s','mh_theta_P','T'); 
    
else %2020
    
    %Load the MH draws
    load('ssnkf_alh_mh_draws_2020.mat','mh_theta','mh_theta_A','mh_theta_B','mh_theta_R_A','mh_theta_R_B','mh_theta_s','mh_theta_P','T');
