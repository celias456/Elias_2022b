function [mh_theta,mh_theta_log_prior,mh_theta_log_likelihood,mh_theta_log_posterior_kernel,acceptance_rate,mh_theta_A,mh_theta_B,mh_theta_s,mh_theta_R_A,mh_theta_R_B,mh_theta_P] = msnkf_al_random_walk_metropolis_hastings_algorithm(theta,Sigma_hat,c,number_draws,number_endogenous_variables,data,number_exogenous_variables,number_aux_variables,number_jumper_variables,number_observed_variables,number_state_variables,number_state_variables_sims,number_total_variables,prior_information,Sigma_u_sd,burn_proportion,first_observation,T)
...
[log_prior,log_likelihood,log_posterior,~,A_initial,B_initial,s_initial,~,R_A_initial,R_B_initial,P_initial] = msnkf_al_log_posterior_calculate(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_jumper_variables,number_observed_variables,number_state_variables,number_state_variables_sims,data,theta,prior_information,Sigma_u_sd,first_observation,T);                                                                                                     
...
for mh_draws_index = 2:number_draws
    ...
    [log_prior,log_likelihood,log_posterior,~,A_candidate,B_candidate,s_candidate,~,R_A_candidate,R_B_candidate,P_candidate] = msnkf_al_log_posterior_calculate(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_jumper_variables,number_observed_variables,number_state_variables,number_state_variables_sims,data,mh_theta_candidate(mh_draws_index,:)',prior_information,Sigma_u_sd,first_observation,T);
